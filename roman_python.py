...
def decomposer_nombre_romain(nombre_romain):
    ...
    liste_decomposition.append(combien_de(unites_romaines, "IV", nombre_romain))
...
def convertir_en_nombre_arabe(nombre_romain):
    liste_decomposition = decomposer_nombre_romain(nombre_romain)
    nombre_arabe = liste_decomposition[0] * 1000 + liste_decomposition[1] * 100 + liste_decomposition[2] * 10 + liste_decomposition[3]
    return nombre_arabe
...
def test_la_conversion_de_MCCXXXIV_retourne_bien_1234():
    conversion = convertir_en_nombre_arabe("MCCXXXIV")
    assert conversion == int("1234", 10)
